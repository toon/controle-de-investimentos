...
const routes = [
  ...
  },
  {
    ...
    meta: { title: "Tipos de Operações em Opção" }
  },
  {
    path: "/tiposopcaostatus",
    name: "tiposopcaostatus",
    component: () => import("../views/TiposOpcaoStatusView.vue"),
    meta: { title: "Tipos de Status em Opção" }
  },
  {
    path: "/tiposativo",
    name: "tiposativo",
